# add eval_cfg.yaml
export Algorithm_Result_Path=/Rocket_ssd/dataset/data_litevloc/traj_eval_data/map_merge_eval_data/algorithms
export Groundtruth_Path=/Rocket_ssd/dataset/data_litevloc/traj_eval_data/map_merge_eval_data/groundtruth
export Report_Path=/Rocket_ssd/dataset/data_litevloc/traj_eval_data/map_merge_eval_data/report
